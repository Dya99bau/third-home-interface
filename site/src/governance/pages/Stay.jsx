...
import { bedSpaces, roleConfig } from '../data'
...
export default function StayPage() {
  ...
  const price = (b) => (role === 'guest' ? b.priceGuest : b.priceMember)
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-12">
      ...
      {booked && (
        <div className="rounded-2xl p-5 mb-8 text-sm font-medium" style={{ background: '#D4EAD0', color: '#2C4A2E' }}>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {rooms.map((b) => (
                <div
                  ...
                  style={{
                    background: 'var(--sand)',
                    borderColor: selected === b.id ? 'var(--terracotta)' : booked === b.id ? 'var(--olive)' : 'transparent',
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-1 mb-4">
                    {b.amenities.map((a) => (
                      <span key={a} className="text-xs px-2 py-0.5 rounded-full" style={{ background: 'var(--cream)', color: 'var(--muted)' }}>
                        {a}
                      </span>
                    ))}
                  </div>
